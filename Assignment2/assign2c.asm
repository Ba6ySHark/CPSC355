...
main:
			...
			mov multiplicand, #240							// Moves the first 8 bits of number -252645136 to the multiplier
			lsl multiplicand, multiplicand, 8					// Logically shifts multiplier left by 8 bits

			mov w27, #240								// Moves the second 8 bits of number -252645136 to the register 27
			orr multiplicand, multiplicand, w27					// Adds these 8 bits to the multiplicand
			lsl multiplicand, multiplicand, 8					// Logically shifts multiplier left by 8 bits

			mov w27, #240								// Moves the third 8 bits of number -252645136 to the register 27
			orr multiplicand, multiplicand, w27					// Adds these 8 bits to the multiplicand
			lsl multiplicand, multiplicand, 8					// Logically shifts multiplicand left by 8 bits

			mov w27, #240								// Moves the last 8 bits of number -252645136 to the register 27
			orr multiplicand, multiplicand, w27					// Adds these 8 bits to the multiplicand

			mov multiplier, #-256							// Sets multiplier to -256
